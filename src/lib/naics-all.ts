// AUTO-GENERATED from Census Bureau 2022 NAICS 6-digit list.
// Do not edit by hand.

export type NaicsEntry = { code: string; title: string };

export const NAICS_2022: NaicsEntry[] = [
...
const NAICS_MAP = new Map(NAICS_2022.map((e) => [e.code, e.title]));

export function naicsTitle(code: string): string | undefined {
  return NAICS_MAP.get(code);
}
