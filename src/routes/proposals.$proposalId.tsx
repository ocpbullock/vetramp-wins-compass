...
import { ArrowLeft, Upload, Download, Sparkles, RefreshCw, FileText, CheckCircle2, Circle, AlertTriangle, Trash2, ExternalLink } from "lucide-react";
...
function ProposalPipeline() {
  ...
  async function patchProposal(patch: Partial<any>) {
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-4 space-y-4">
        ...
        <Tabs value={step} onValueChange={setStep}>
          ...
          <TabsContent value="generate" className="mt-4 space-y-4">
            <GenerateStep proposal={proposal} sectionGen={sectionGen} onGenerate={generateSection} onGenerateAll={generateAll} onPatchSection={(id, content) => {
